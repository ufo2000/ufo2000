...
CFLAGS += -pipe -DLINUX
CFLAGS += -O3 -mcpu=i686 -s -fomit-frame-pointer
INCLUDES = `allegro-config --cflags`
CFLAGS += $(INCLUDES)
LIBS = $(addprefix -l,$(LIBRARIES)) `allegro-config --libs`
...
OBJS = about.o bullet.o cell.o config.o connect.o dirty.o editor.o explo.o \
       ...
       terrapck.o units.o video.o wind.o word.o crc32.o persist.o jpeg.o
