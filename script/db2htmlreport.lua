...
io.write("<tr><td>name<td>games played<td>games won<td>ELO score<td>")
...
io.write("<br> <b>UFO2000 played games statistics table</b><br>")
io.write("<table border=1>\n")
io.write("<tr><td>game<td>version<td>player1<td>player2<td>result<td>comment<td>\n")
...
io.write(string.format("<br>report generated on %s<br>server log parsing performed for %.2f seconds", os.date(), os.clock()))
io.write("</body></html>")
db:close()
