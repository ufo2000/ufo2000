...
AddImage("smoke_small", png_image_set("$(ufo2000)/arts/fire_frames/32x40", 1, 4, true))
AddImage("smoke_medium", png_image_set("$(ufo2000)/arts/fire_frames/32x40", 5, 4, true))
AddImage("smoke_large", png_image_set("$(ufo2000)/arts/fire_frames/32x40", 5, 4, true))
