        ...
        if ((sx > -32) && (sx < SCREEN2W) && (sy >= -34) && (sy < SCREEN2H)) {
            if (!subsequent_turn) {
                ...
                if (TU < sld->tus_reserved() &&
                    ...
                    TU_color = 32; //If COLOR_RED00 is used, then assert fails at line 123 of video.cpp
                }
            ...
            if (TU < 0) {
                ...
                TU_color =  4; //If COLOR_GRAY04 is used, then assert fails at line 123 of video.cpp
            }
            if (TU < 0) break;
